...
async function main() {
  ...
  console.log(`Found ${items.length} old files under tunglamhoaphuc2/tong-chi/`);
  ...
  if (items.length > 0) {
    ...
    console.log(`✅ Deleted old tunglamhoaphuc2/tong-chi/ folder from S3. Now only tunglamhoaphuc2/tong-chi-tu-hoc/ exists!`);
  }
}
