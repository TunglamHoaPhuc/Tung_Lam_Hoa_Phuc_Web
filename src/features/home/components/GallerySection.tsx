...
const FEATURED_AREAS: AreaItem[] = [
  ...
  {
    id: "a2",
    name: "BẢO THÁP SRILANKA & MANDALA",
    subtitle: "Bảo tháp 5 tầng tôn trí xá lợi Phật & Mandala chư Phật Bồ Tát",
  ...
  {
    id: "a3",
    name: "TỔ ĐƯỜNG & VÃNG SINH ĐƯỜNG",
    subtitle: "Nơi tôn thờ Ngộ Chân Tử Sư Tổ & Chư Lịch Đại Tổ Sư Tông Phong",
