...
export function KhoiBoSuuTapAnh({ photoGallery, onSelectPhoto }: PropsBoSuuTapAnh) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
        {items.map((item, idx) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-black/35 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-6 backdrop-blur-[1px]">
