...
export function KhoiTimHieuThem({ relatedArticles }: PropsTimHieuThem) {
        ...
        <div className="flex items-center justify-between gap-4 w-full border-b border-[#c8aa6e]/30 pb-3">
          ...
          <div className="flex items-center gap-4 flex-shrink-0">
            <h2
              ...
              className="text-2xl sm:text-4xl font-normal text-[#ffde59] uppercase tracking-wider drop-shadow-[0_2px_10px_rgba(255,222,89,0.3)]"
            >
              TÌM HIỂU THÊM
            </h2>
          </div>
        ...
        >
          {items.map((item, idx) => (
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-4 sm:p-5 text-left space-y-1.5">
                <span
